...
const LoanComponent = () => {
  ...
  const { register, handleSubmit, watch, reset, formState: { errors }, getValues, control } = useForm({
    Income: "",
    loanAmount: "",
    duration: "",
    purpose: "",
  ...
  return (<>
    ...
    <div className="form-style">
      ...
      {loggedIn && loandetails && (loandetails[0]?.AccountDetails === undefined && (
        <Alert variant="danger">
          *Please update Payment details before applying for Loan
        </Alert>
      ))
      }
      {loggedIn ? (
        <Card className='border-css'>
          <Card.Header className="text-center" as="h5">Loan Form</Card.Header>
          <Card.Body>
            <Form noValidate onSubmit={handleSubmit(onSubmit)} >
              ...
              <Row className="mb-3">
                ...
                <Col>
                  ...
                  <Form.Control type="text" placeholder="Normal text" Value={watchpurpose === "Others" ? "10" : watchpurpose === "Car Loan" ? "7" : watchpurpose === "Home Loan" ? "8" : "10"} />
                </Col>
              </Row>
              <Button type="submit" disabled={(loandetails && (loandetails[0]?.AccountDetails === undefined)) ? true : false} data-testid="btn-loan">Apply</Button>
            </Form>
          </Card.Body>
